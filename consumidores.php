<?php require("header.php"); ?>
 ...
 <p>&nbsp;</p>
                 <a href="add-consumidores.php" class="btn btn-primary">Adicionar consumidor</a>
                 <p>&nbsp;</p>
...
<tr>
   ...
   <td>
      <a href="editar-consumidor.php?id=<?php echo $linha[$i]["id"]; ?>" class="btn btn-warning btn-xs">editar usuário</a>
      <a href="consumidores.php?id=<?php echo $linha[$i]["id"]; ?>" class="btn btn-danger btn-xs">excluir</a>
   </td>

	...
	<div class="page-head">
		<div class="container">
			...
			<div class="page-title">
				<h1>Adicionar novo Representante Cinpal</h1>
			</div>
			<!-- END PAGE TITLE -->
			<!-- BEGIN PAGE TOOLBAR -->
		...
		<div class="container">
            ...
            <div class="row margin-top-10">
              ...
              <div class="col-md-8 portlet light">
                ...
                ?>
                  <p>&nbsp;</p>
                  <form method="post" action="action-add-representante-pai.php" onSubmit="return ajaxSubmit(this);">                    
                      ...
                      <div class="form-group">
                        ...
                        <p class="help-block">Um representante pode ser Regional ou Nacional</p>
                      </div>

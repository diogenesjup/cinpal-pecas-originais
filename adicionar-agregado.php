		...
		<div class="container">
            ...
            <div class="row margin-top-10">
              ...
              <div class="col-md-8 portlet light">
                ...
                ?>
                  <p>&nbsp;</p>
                  <a href="adicionar-agregado.php" class="btn btn-primary">adicionar novo agregado</a>
                  <p>&nbsp;</p>
                  <form method="post" action="action-add-agregado.php" onSubmit="return ajaxSubmit(this);">                    
                      ...
                      <div class="form-group">
                        ...
                        <input type="text" name="descricao" class="form-control" placeholder="Descrição do nome da origem, exemplo: Motor" />
                      </div>

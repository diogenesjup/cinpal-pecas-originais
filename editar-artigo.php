	...
	<div class="page-head">
		<div class="container">
			...
			<div class="page-title">
				<h1>Site <small>Artigos > Editar artigo</small></h1>
			</div>
			<!-- END PAGE TITLE -->
			<!-- BEGIN PAGE TOOLBAR -->
...
<div class="tab-content" style="padding:20px;">
  ...
  <div role="tabpanel" class="tab-pane fade in active" id="home">
                  ...
                  <form method="post" action="action-editar-artigo.php" onSubmit="return ajaxSubmit(this);">                       
    ...
    <script type="text/javascript">
           // 
            ...
            var ajaxSubmit = function(form) {
                ...
                swal("Bom trabalho!", 'Artigo atualizado com sucesso', "success");

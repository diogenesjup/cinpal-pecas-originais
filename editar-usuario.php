		...
		<div class="container">
            ...
            <div class="row margin-top-10">
              ...
              <div class="col-md-8 portlet light">
                ...
                ?>
                  <p>&nbsp;</p>
                  <form method="post" action="action-editar-usuario.php" onSubmit="return ajaxSubmit(this);">
                      ...
                      <div class="form-group">
                          ...
                          <input type="textp" class="form-control" name="username" value="<?php echo $usuario[0]["login"]; ?>" />
                      </div>
                      ...
                      <div class="form-group">
                        ...
                        <select class="form-control" name="grupo">
                          ...
                          <?php if($grupo_usuario == "admin" ): ?>     
                          <option value="admin" <?php if($usuario[0]["grupo"]=="admin") echo "selected";  ?>>-- Administrador --</option>
                          <?php endif; ?>


                          <option value="representantes" <?php if($usuario[0]["grupo"]=="representantes") echo "selected";  ?>>-- Representante / Colaborador --</option>
                          <option value="representantes_comerciais"  <?php if($usuario[0]["grupo"]=="representantes_comerciais") echo "selected";  ?>>-- Representante Comercial --</option>
                        </select>

	...
	<div class="page-head">
		<div class="container">
			...
			<div class="page-title">
				<h1>Editar Representante Cinpal</h1>
			</div>
			<!-- END PAGE TITLE -->
			<!-- BEGIN PAGE TOOLBAR -->
		...
		<div class="container">
            ...
            <div class="row margin-top-10">
              ...
              <div class="col-md-8 portlet light">
                ...
                ?>
                  <p>&nbsp;</p>
                  <form method="post" action="action-editar-representante-pai.php" onSubmit="return ajaxSubmit(this);">                    
                      ...
                      <div class="form-group">
                        ...
                        <select name="tipo" class="form-control">
                           <option value="nacional" <?php if($usuario[0]["tipo"]=="nacional") echo "selected"; ?>>-- NACIONAL --</option>
                           <option value="regional" <?php if($usuario[0]["tipo"]=="regional") echo "selected"; ?>>-- REGIONAL --</option>
                        </select>
                      </div>

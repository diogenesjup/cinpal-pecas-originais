		...
		<div class="container">
            ...
            <div class="row margin-top-10">
              ...
              <div class="col-md-8 portlet light">
                  ...
                  $sql = "SELECT * FROM representantes_comerciais WHERE id = '$id'";
                  $result = $PDO->query( $sql );
                  $usuario = $result->fetchAll( PDO::FETCH_ASSOC );

                ?>
                  <p>&nbsp;</p>
                  <form method="post" action="action-editar-representante-comercial.php" onSubmit="return ajaxSubmit(this);">                    

  ...
  <div class="page-content">
    <div class="container">
            ...
            <div class="row margin-top-10">
              ...
              <div class="col-md-12 portlet light" style="min-height:550px;">

              <p>&nbsp;</p>
              <h2>Selecione a tabela a ser importada</h2>
              <p>&nbsp;</p>

                      <form id="form_image" method="post" enctype="multipart/form-data" action="upload-excel-2.php">                                                          

                            

                             <div class="form-group">
                                <label>2º Tabela de <b>Produtos x Aplicações x Veículos</b></label>
                                <input type="file" id="imagem" name="imagem">
                                <p class="help-block">Selecione apenas JPG ou PNG com no máximo 50MB.</p>
                              </div>

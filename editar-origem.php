	...
	<div class="page-head">
		<div class="container">
			...
			<div class="page-title">
				<h1>Editar origem de produto</h1>
			</div>
			<!-- END PAGE TITLE -->
			<!-- BEGIN PAGE TOOLBAR -->
		...
		<div class="container">
            ...
            <div class="row margin-top-10">
              ...
              <div class="col-md-8 portlet light">
                  ...
                  $sql = "SELECT * FROM origem WHERE id = '$id_origem'";
                ...
                ?>
                  <p>&nbsp;</p>
                  <form method="post" action="action-editar-origem.php" onSubmit="return ajaxSubmit(this);">                    
                      
                      <input type="hidden" name="id_origem" value="<?php echo $id_origem; ?>" />

                      <div class="form-group">
                        <label>Nº Origem:</label>
                        <input type="text" name="num_origem" class="form-control" value="<?php echo $origem[0]["origem"]; ?>" />
                      </div>

<?php require("header.php"); ?>
 ...
 <p>&nbsp;</p>
                 <a href="add-representantes-comerciais.php" class="btn btn-primary">Adicionar Oficina</a>
                 <p>&nbsp;</p>
...
<tr>
   ...
   <td>
      <a href="editar-representante-comercial.php?id=<?php echo $linha[$i]["id"]; ?>" class="btn btn-warning btn-xs">editar</a>
...
<script type="text/javascript">
    ...
    swal({   title: "Confirma a exclusão da oficina?",   text: "Essa ação não pode ser revertida",   type: "warning",   showCancelButton: true,   confirmButtonColor: "#DD6B55",   confirmButtonText: "Sim, apagar",   cancelButtonText: "Não, cancelar!",   closeOnConfirm: false,   closeOnCancel: false }, function(isConfirm){   if (isConfirm) {   swal("Apagado!", "Oficina apagada com sucesso.", "success");  location.href="excluir-representante-comercial.php?id=<?php echo $_GET['id']; ?>" } else {     swal("Cancelado", "Pedido cancelado", "error");   } });
...
if($_GET["status"]=="sucesso"): echo '<script type="text/javascript">swal("Muito bem!", "Oficina foi removida com sucesso", "success");</script>'; endif; ?>

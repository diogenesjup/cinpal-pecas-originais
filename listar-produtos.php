<?php require("header.php"); ?>
 ...
 <p>&nbsp;</p>
                 <a href="importar-produtos.php" class="btn btn-primary">Importar produtos</a>
                 <p>&nbsp;</p>
                 ...
                 <table id="dataSelect" data-order='[[ 0, "asc" ]]' class="table table-hover">
                  <thead>
                    ...
                    <th style="padding-left:8px;width:177px !important;"><b>Descrição</b></th>
...
<tr>
   ...
   <td style="width:177px !important;"><?php echo $linha[$i]["descricao"]; ?></td>
